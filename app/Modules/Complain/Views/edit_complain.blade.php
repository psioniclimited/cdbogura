    ...
    <script>
        $(document).ready(function () {
            ...
            $('#customer_id').select2({
                allowClear: true,
                data: [{
                    id: '{{ $complain->customer->customers_id  }}',
                    text: '{{ $complain->customer->name  }}' +' ('+ '{{ $complain->customer->customer_code  }}'+ ')'
                }],
...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form starts here -->
            {!! Form::open(array('url' => 'edit_complain_process', 'id' => 'edit_complain_process', 'class' => 'form-horizontal')) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group @if ($errors->has('date')) has-error @endif">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" id="date" name="date" value="{{ $complain->date }}">
                        </div>
                        @if ($errors->has('date')) <p class="help-block">{{ $errors->first('date') }}</p> @endif
                    </div>
                    <div class="form-group @if ($errors->has('description')) has-error @endif">
                        <label>Description*</label>
                        <input type="text" class="form-control" id="description" name="description" placeholder="Enter Description" value="{{ $complain->description }}">
                ...
                <div class="col-md-4">
                    <div class="form-group @if ($errors->has('complain_status')) has-error @endif">
                        ...
                        <select class="form-control" name="complain_status_id" id="complain_status_id">
                            <option value="{{ $complain->complain_status->id }}">{{$complain->complain_status->status}}</option>
