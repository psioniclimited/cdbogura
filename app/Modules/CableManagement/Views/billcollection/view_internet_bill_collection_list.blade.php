...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#show').on('click', function(e){
            ...
            // Collection Count
            $.ajax({
                url: "{{URL::to('/internetcollectionamount')}}",
                data:{
            ...
            .done(function( data ) {
                // Set amount
                $('#internet_collection_sum').html(data);
            });
        });
        ...
        $('#clear_filter').on('click', function(e){
            ...
            $('#internet_collection_sum').html(0);
        });
        ...
        $('#confirm_refund').on('shown.bs.modal', function(e) {
            ...
            $('#refund_modal_form').submit(function(e){
                ...
                $.ajax({
                    cache: false,
                    type: 'POST',
                    url: '{{URL::to('/refund_internet_bill_process')}}',
                    data: {
                        bill_id
                    },
        ...
        $('#confirm_discount').on('shown.bs.modal', function(e) {
            ...
            $('#discount_modal_form').submit(function(e){
                ...
                $.ajax({
                    cache: false,
                    type: 'POST',
                    url: '{{URL::to('/discount_internet_bill_process')}}',
                    data: {
                        form_data,
                        discount_bill_id
                    },
    ...
    <div class="col-xs-12">            
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Bill Collection List of Internet Customers</h3>
            </div>
            <!-- /.box-header -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-green">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number banner-font" id="internet_collection_sum"></span>
                            </div>
                        </div>
                    </div>  
                </div>
...
{!! Form::open(array('url' => 'refund_internet_bill_process', 'id' => 'refund_modal_form')) !!}
...
{!! Form::open(array('url' => 'discount_internet_bill_process', 'id' => 'discount_modal_form')) !!}
