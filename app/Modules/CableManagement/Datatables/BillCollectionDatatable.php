...
class BillCollectionDatatable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'sector' => ['data' => 'customers.house.road.sector.sector', 'name' => 'customers.house.road.sector.sector', 'orderable'=> false, 'searchable' => false],
            'road' => ['data' => 'customers.house.road.road', 'name' => 'customers.house.road.road', 'orderable'=> false, 'searchable' => false],
