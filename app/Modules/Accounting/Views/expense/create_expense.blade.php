...
<section class="content">
    ...
    <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form starts here -->
        {!! Form::open(array('url' => 'create_expense_process', 'id' => 'create_expense_category_process', 'class' => 'form-horizontal')) !!}
        <div class="box-body">
            <div class="col-md-4">
                <div class="form-group @if ($errors->has('transaction_date')) has-error @endif">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="transaction_date" name="transaction_date" value="{{old('transaction_date')}}">
                    </div>
                ...
                <div class="form-group @if ($errors->has('note')) has-error @endif">
                    ...
                    <input type="text" class="form-control" id="note" name="note" placeholder="Enter Description" value="{{old('note')}}">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group @if ($errors->has('ref_number')) has-error @endif">
                    ...
                    <input type="text" class="form-control" id="ref_number" name="ref_number" placeholder="Enter Reference no" value="{{old('ref_number')}}">
                    @if ($errors->has('ref_number')) <p class="help-block">{{ $errors->first('ref_number') }}</p> @endif
                </div>
                <div class="form-group @if ($errors->has('amount')) has-error @endif">
                    <label>Amount*</label>
                    <input type="number" min="0" class="form-control" id="amount" name="amount" placeholder="Enter Amount" value="{{old('amount')}}">
